...
import { 
  ...
  Lightbulb, Sparkles, AlertCircle, MoreHorizontal, PieChart
} from "lucide-react";
...
const IncomePage = () => {
  ...
  // Split categories into chunks of 3 for carousel
  ...
  return (
    <div className="min-h-screen bg-black pb-28">
      ...
      <div className="container mx-auto px-4 py-6 space-y-6">
        ...
        {/* =============================================== */}
        {/* Por Categoría - NUEVO CARRUSEL CON BARRAS DE PROGRESO */}
        {/* =============================================== */}
        {totalIncome > 0 && sortedCategories.length > 0 && (
          <Card className="bg-zinc-900 border-zinc-800">
                        ...
                        <CarouselItem key={chunkIndex} className="p-0">
                          <div className="space-y-3 px-1">
                            {chunk.map(({ category, amount }) => {
                              ...
                              const isPassive = cat.value === 'rental' || cat.value === 'investments';
                              
                              return (
                                <div 
                                  key={category} 
                                  className="flex items-center gap-3 p-3 bg-zinc-800/50 rounded-xl hover:bg-zinc-800/70 transition-all border border-zinc-700/50 hover:border-green-500/30"
                                >
                                  ...
                                  <div className="flex-1 min-w-0 mx-2">
                                    <div className="flex items-center justify-between mb-1.5">
                                      ...
                                      <p className={`text-[10px] font-medium ml-2 flex-shrink-0 ${
                                        isPassive ? 'text-green-400/80' : 'text-blue-400/80'
                                      }`}>
      ...
      <Dialog open={isNewInvestmentOpen} onOpenChange={setIsNewInvestmentOpen}>
        <DialogContent className="bg-zinc-900 border-zinc-800">
          ...
          <button 
            ...
            className="absolute right<dyad-write path="src/pages/dashboard/IncomePage.tsx" description="Updating IncomePage with new carousel section for categories with progress bars, navigation arrows, and better position indicators">
"use client";
  ...
  return (
    <div className="min-h-screen bg-black pb-28">
      ...
      <div className="container mx-auto px-4 py-6 space-y-6">
        ...
        {/* =============================================== */}
        {/* Por Categoría - CARRUSEL CON BARRAS DE PROGRESO */}
        {/* =============================================== */}
        {totalIncome > 0 && sortedCategories.length > 0 && (
          <Card className="bg-zinc-900 border-zinc-800">
            <CardHeader className="pb-2">
      ...
      <Dialog open={isNewPatrimonyOpen} onOpenChange={setIsNewPatrimonyOpen}>
        <DialogContent className="bg-zinc-900 border-zinc-800">
          ...
          <button onClick={() => setIsNewPatrimonyOpen(false)} className="absolute right-4 top-4 p-1 rounded-full bg-zinc-800 hover:bg-zinc-700 text-white">
            <X className="w-4 h-4" />
          </button>
          <div className="space-y-3 mt-4">
...
const IncomeForm = ({
  income, setIncome, onSubmit, isSubmitting, isNew,
      ...
      <div>
        ...
        <Dialog open={isCategoryDialogOpen} onOpenChange={setIsCategoryDialogOpen}>
          ...
          <DialogContent className="bg-zinc-900 border-zinc-800 max-h-[80vh] overflow-y-auto">
            ...
            <button onClick={() => setIsCategoryDialogOpen(false)} className="absolute right-4 top-4 p-1 rounded-full bg-zinc-800 hover:bg-zinc-700 text-white">
              <X className="w-4 h-4" />
            </button>
            <div className="space-y-3 mt-4">
