...
import { 
  ...
  Wallet, PiggyBank, Building, ShoppingCart, 
  Laptop, Globe, TrendingDown,
  Pencil, Trash2, TrendingDown as TrendingDownIcon,
    ...
    <div className="space-y-4 mt-4">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <TrendingDown className={`w-5 h-5 ${income.is_recurring ? "text-green-400" : "text-zinc-400"}`} />
